...
public class FoodDeliveryServiceDemo {
    public static void main(String[] args) {
        ...
        restaurant1Menu.add(new MenuItem("M001", "Burger", 9.99));
        restaurant1Menu.add(new MenuItem("M002", "Pizza",  12.99));
        ...
        restaurant2Menu.add(new MenuItem("M003", "Sushi",  15.99));
        restaurant2Menu.add(new MenuItem("M004", "Ramen", 10.99));
        ...
        Order order = deliveryService.placeOrder(customer1.getCustomerId(), restaurant1.getRestaurantId(), orderItems);

        // Update order status
        deliveryService.updateOrderStatus(order.getOrderId(), OrderStatus.CONFIRMED);
        System.out.println("Order status updated: " + order.getOrderStatus());

        // Cancel an order
        Order order2 = deliveryService.placeOrder(customer2.getCustomerId(), restaurant2.getRestaurantId(), List.of(new OrderItem(restaurant2Menu.get(0), 1)));
